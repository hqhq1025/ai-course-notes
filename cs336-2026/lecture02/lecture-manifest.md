...
- `cover.jpg`
- `lecture02-blueprint.md`
- `lecture02-coverage.md`
- `lecture02-manifest.md`
- `lecture02-notes.pdf`
- `lecture02-notes.tex`
- `lecture02-slides.py`
...
| py-007 | figure | yes | `lecture02-slides.py:main` | images/marin-forecast-result.jpg |
...
| py-068 | figure | yes | `lecture02-slides.py:tensors_memory` | images/fp8-formats.png |
