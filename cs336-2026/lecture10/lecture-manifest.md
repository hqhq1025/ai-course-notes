...
| py-204 | figure | yes | `lecture10-slides.py:quantization` | images/fp8-quantization.png |
...
| py-272 | figure | yes | `lecture10-slides.py:continuous_batching` | images/continuous-batching-static.png |
