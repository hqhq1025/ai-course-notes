...
- `lecture13-blueprint.md`
- `lecture13-coverage.md`
- `lecture13-manifest.md`
- `lecture13-notes.pdf`
- `lecture13-notes.tex`
- `lecture13-slides.py`
...
- `images/dolma-overview.png`
- `images/llama3-data.png`
- `images/nemotron-results.png`
- `images/olmo2-dolmino.png`
- `images/olmo2-pretraining.png`
- `images/stackv2-pr1.png`
- `images/stackv2-pr2.png`
- `images/the-pile.png`
- `images/tulu.png`
- `images/webcrawler-architecture.png`
...
| py-167 | figure | yes | `lecture13-slides.py:common_crawl` | images/webcrawler-architecture.png |
...
| py-345 | figure | yes | `lecture13-slides.py:dolma` | images/dolma-overview.png |
