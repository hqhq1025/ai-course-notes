...
- `images/agents-overview.png`
- `images/air-overview.png`
- `images/alpacaeval-correlation.png`
- `images/alpacaeval-leaderboard.png`
- `images/arc-agi-2-unsolved.png`
- `images/arc-agi-3-results.png`
- `images/arc-agi-3.png`
- `images/arc-agi-results.png`
- `images/arc-task-grids.jpg`
...
- `images/karpathy-nanogpt-speedrun.png`
- `images/lambada.png`
- `images/lmarena-leaderboard.png`
- `images/medhelm-overview.png`
- `images/mlebench-results.png`
- `images/mlebench.png`
- `images/mmlu-pro.png`
- `images/mmlu.png`
- `images/openrouter.png`
- `images/platinum-1.jpg`
- `images/platinum-2.jpg`
- `images/swebench.png`
...
| py-125 | figure | yes | `lecture12-slides.py:chat_benchmarks` | images/alpacaeval-correlation.png |
...
| py-181 | figure | yes | `lecture12-slides.py:pure_reasoning_benchmarks` | images/arc-agi-2-unsolved.png |
...
| py-192 | figure | yes | `lecture12-slides.py:safety_benchmarks` | images/crash-test.jpg |
...
| py-199 | figure | yes | `lecture12-slides.py:safety_benchmarks` | images/air-overview.png |
...
| py-219 | figure | yes | `lecture12-slides.py:realism` | images/medhelm-overview.png |
...
| py-245 | figure | yes | `lecture12-slides.py:validity` | images/platinum-1.jpg |
| py-246 | figure | yes | `lecture12-slides.py:validity` | images/platinum-2.jpg |
