...
- `lecture06-blueprint.md`
- `lecture06-coverage.md`
- `lecture06-manifest.md`
- `lecture06-notes.pdf`
- `lecture06-notes.tex`
- `lecture06-slides.py`
...
| py-028 | figure | yes | `lecture06-slides.py:review_of_gpus` | images/cuda-grid.png |
...
| py-078 | figure | yes | `lecture06-slides.py:review_of_gpus` | images/block-occupancy.png |
...
| py-125 | figure | yes | `lecture06-slides.py:triton_introduction` | images/cuda-grid.png |
